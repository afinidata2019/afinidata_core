    ...
    def post(self, request, *args, **kwargs):
        ...
        if 'article' in form.data:
            ...
            return JsonResponse(dict(set_attributes=dict(
                ...
                article_content=("%s/articles/%s/?key=%s" % (os.getenv('CONTENT_MANAGER_DOMAIN'), article.pk,
        ...
        return JsonResponse(dict(
            set_attributes=dict(
                ...
                article_id=article.pk,
                article_name=article.name,
                article_content=("%s/articles/%s/?key=%s&instance=%s" % (os.getenv('CONTENT_MANAGER_DOMAIN'), article.pk,
