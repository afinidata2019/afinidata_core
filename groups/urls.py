...
urlpatterns = [
    ...
    path('<int:group_id>/dashboard/v2/', views.GroupDashboardV2View.as_view(), name='group_dashboard_v2'),
    path('<int:group_id>/get_users/', views.GroupUsersViewService.as_view(), name='group_get_users'),
    ...
    path('<int:group_id>/add_program/', views.AddProgramView.as_view(), name='add_program'),
    path('<int:group_id>/add_bot/', views.AddBotView.as_view(), name='add_bot')
]
